    ...
    <header className="header">
      ...
      <div className="header__main">
        <div className="header__container">
          <Link to="/" className="header__logo">
            <img src="/logo/logo.png" alt="Avytrendy" className="header__logo-img" />
          </Link>
      ...
      <div className={`mobile-menu ${mobileMenuOpen ? 'mobile-menu--open' : ''}`}>
        ...
        <nav className="mobile-menu__nav">
          ...
          <Link to="/track-order" className="mobile-menu__link mobile-menu__link--icon" onClick={() => setMobileMenuOpen(false)}>
          ...
          {user && (
            <Link to="/wishlist" className="mobile-menu__link mobile-menu__link--icon" onClick={() => setMobileMenuOpen(false)}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
              </svg>
